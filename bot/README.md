...
На этом этапе база данных, сайт, Instagram API, CRM и массовые рассылки не подключены. Команда `/admin` уже есть, но показывает заглушку до появления базы пользователей.
